...
public class Service {
    ...
    public void creareClient(Scanner in) throws ParseException {
        ...
        if(this.db.readClient() != null)
            this.db.createClient(newClient);
    ...
    public void creareContClient(Scanner in) throws Exception {
        ...
        if(this.db.readCont() != null)
            this.db.createCont(newCont);
    ...
    public void creareContEconomiiClient(Scanner in) throws Exception {
        ...
        System.out.println("CNP-ul clientului: ");
        String CNP = in.nextLine();
        ContEconomii newCont = this.contFactory.creareContEconomii(CNP, client.getId_client());
        conturi.add(newCont);
        mapConturi.put(newCont.getIBAN(), newCont);
        if(this.db.readContEconomii() != null)
            this.db.createCont(newCont);
    ...
    public void creareTranzactie(Scanner in) throws Exception {
        ...
        var newTranzactie = new Tranzactie(IBAN1, IBAN2, suma, data_acum);
        this.tranzactii.add(newTranzactie);
        if(this.db.readTranzactie() != null)
            this.db.createTranzactie(newTranzactie);
